...
public class RiskAndProblemApp {

    private static final Logger log = LoggerFactory.getLogger(RiskAndProblemApp.class);

    private final Environment env;

    public RiskAndProblemApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes RiskAndProblem.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(RiskAndProblemApp.class);
